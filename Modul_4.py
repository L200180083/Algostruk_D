...
c0 = MhsTIF('Ika', 15, 'Jogja', 243000)
c1 = MhsTIF('Budi', 31, 'Demak', 230000)
c2 = MhsTIF('Ahmad', 22, 'Surakarta', 250000)
c3 = MhsTIF('Chandra', 21, 'Kudus', 235000)
c4 = MhsTIF('Eka', 44, 'Boyolali', 243000)
c5 = MhsTIF('Fandi', 21, 'Pati', 249000)
c6 = MhsTIF('Deni', 53, 'Klaten', 245000)
c7 = MhsTIF('Galuh', 51, 'Jepara', 245000)
c8 = MhsTIF('Janto', 33, 'Klaten', 235000)
c9 = MhsTIF('Hasan', 42, 'Kudus', 275000)
c10 = MhsTIF('Khalid', 29, 'Purwodadi', 270000)
